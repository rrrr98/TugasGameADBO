...
public class TestSpatialAnim extends SimpleApplication {
    ...
    private String[] animNames = {"Dodge", "RunBase", "RunTop","pull", "push"};
    ...
    public void simpleUpdate(float tpf) {
        ...
        if (jump) {
            feetChannel.setAnim("JumpStart");
            torsoChannel.setAnim("JumpStart");
    ...
    private void loadModel() {
        ...
        TextureKey k = new TextureKey("Models/Sinbad/sinbad_body.jpg", false);
        TextureKey l = new TextureKey("Models/Sinbad/sinbad_clothes.jpg", false);
        TextureKey kk = new TextureKey("Models/Sinbad/sinbad_sword.jpg", false);
        m.setTexture("ColorMap", assetManager.loadTexture(k));
        m.setTexture("ColorMap", assetManager.loadTexture(l));
        m.setTexture("ColorMap", assetManager.loadTexture(kk));
        
        modelCharacter = (Spatial) assetManager.loadModel("Models/Sinbad/Sinbad.mesh.j3o");
        ...
        torsoChannel = control.createChannel();
        feetChannel = control.createChannel();
        
        torsoChannel.setAnim(animNames[2]);
        feetChannel.setAnim(animNames[1]);
