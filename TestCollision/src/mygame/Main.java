...
public class Main extends SimpleApplication
    ...
    public void simpleInitApp() {
        ...
        sceneModel = assetManager.loadModel("Models/joined.blend");
        CollisionShape sceneShape
                = CollisionShapeFactory.createMeshShape(sceneModel);
        //sceneModel.move(camLeft);
        ...
        CapsuleCollisionShape capsuleShape = new CapsuleCollisionShape(0.5f, 6f, 1);
    ...
    public void simpleUpdate(float tpf) {
        if (lifeStatus) {
            ...
            System.out.println("x : " + cam.getLocation().getX());
            System.out.println("y : " + cam.getLocation().getY());
            System.out.println("z : " + cam.getLocation().getZ());
            if (cam.getLocation().getY() < -15) {
                lifeStatus = false;
